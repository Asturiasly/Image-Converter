...
namespace img_lib {
        ...
        PACKED_STRUCT_BEGIN BitmapInfoHeader
    {
        ...
        int32_t width;
        int32_t height;
        unsigned short number_color_planes;
        unsigned short bits_per_pixel;
        uint32_t pixel_compression;
        uint32_t size_bitmap_array;
    ...
    bool SaveBMP(const Path& file, const Image& image)
    {
        ...
        file_h.filesize = stride * image.GetHeight();
        file_h.unused = 0;
